...
export const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async (role: 'student' | 'admin') => {
    ...
    try {
      ...
      setSelectedRole(role); // Go to that role's form card to display error
    } finally {
        ...
        {selectedRole === null ? (
          ...
          >
            <div className="text-center space-y-3">
              ...
              <h1 className="text-3xl font-extrabold text-[#0F172A] tracking-tight">Choose Your Portal</h1>
              <p className="text-base text-[#64748B] max-w-md mx-auto">
                Sign in to manage student career assessments or monitor administration analytics.
              </p>
            </div>

            {/* Error display if Google Login failed on landing */}
            {error && (
              <div className="max-w-md mx-auto bg-red-50 border border-red-200 text-red-700 p-3.5 rounded-md flex items-start gap-2.5 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 border border-[#E5E7EB] rounded-lg shadow-sm flex flex-col justify-between space-y-6 hover:shadow-md transition-shadow">
                <div className="space-y-4">
                  ...
                  <p className="text-base text-[#475569] leading-relaxed">
                    Access career assessments, Career Readiness Score, Skill Gap Analysis, AI Mentor, Learning Roadmap, Reports, and Profile.
                  </p>
                </div>
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-white border border-[#E5E7EB] hover:bg-[#F8FAFC] text-[#0F172A] rounded-md text-sm font-bold shadow-sm transition-colors cursor-pointer flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-[#2563EB] hover:bg-blue-700 text-white rounded-md text-sm font-bold shadow-sm transition-colors cursor-pointer"
                  >
                    Continue with Email
                  </button>
                </div>
              ...
              <div className="bg-white p-8 border border-[#E5E7EB] rounded-lg shadow-sm flex flex-col justify-between space-y-6 hover:shadow-md transition-shadow">
                <div className="space-y-4">
                  ...
                  <p className="text-base text-[#475569] leading-relaxed">
                    Manage students, view analytics, monitor predictions, manage reports, and control application settings.
                  </p>
                </div>
                <div className="space-y-3">
                  <button
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-[#0F172A] hover:bg-slate-800 text-white rounded-md text-sm font-bold shadow-sm transition-colors cursor-pointer"
                  >
                    Continue with Email
                  </button>
                </div>
          ...
          >
            ...
            >
              <ArrowLeft className="w-4 h-4" /> Choose Your Portal
            </button>
